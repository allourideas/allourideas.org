...
/*
	...
	*/
        ...
        $('#view_voter_map').click(function(event){
			...
			{
			        var iframe_html= "<tr id=voter_map_row class='row1'><td class='title' colspan='2' style='text-align:center' height=370px><div id='voter_map_indicator'><img src='/images/indicator.gif' /></div><iframe id='voter_map_iframe' src='" + $(this).attr('href') + "' onload='iframe_loaded();' width='722px' height='370px' frameborder=0 scrolling=no style='border:1px solid rgb(145,145,145);'></iframe></td></tr>"
				$('#view_voter_map_row').after(iframe_html);
